...
Każdy projekt porusza inne aspekty programowania: od integracji z zewnętrznymi API i tworzenia GUI, przez systemy współbieżne na plikach, aż po optymalizację algorytmiczną.
